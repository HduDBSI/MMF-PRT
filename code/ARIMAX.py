...
if __name__ == '__main__':
    ...
    for i in range(1, 10):
        ...
        temp_preds = result.forecast(steps=len(y_val), exog=X_val)
        _, temp_mae, temp_rmse, _, temp_r2 = evaluate(y_val, temp_preds)
    ...
    val_preds = best_result.forecast(steps=len(y_val), exog=X_val)
